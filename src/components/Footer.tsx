...
const resourceLinks = [
  { label: "Plattform", href: "#ressourcen" },
  ...
  return (
    <footer className="border-t border-border-subtle-light/15 bg-white/80">
      <div className="mx-auto w-full max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 flex flex-col items-start gap-2 border-t border-border-subtle-light/15 pt-6 text-xs text-text-secondary-light sm:flex-row sm:items-center sm:justify-between">
